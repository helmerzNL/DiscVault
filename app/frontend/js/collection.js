...
async function openMovieDetail(id, skipGroupRedirect) {
  ...
  d.innerHTML = [
    ...
    movie.barcode ? `<div class="detail-item"><label>UPC/EAN / DiscVault ID</label><span style="font-family:'DM Mono',monospace;font-size:0.8rem">${escHtml(movie.barcode)}</span></div>` : '',
