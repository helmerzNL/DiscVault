...
class NextProfileUiTests(unittest.TestCase):
    ...
    def test_library_action_groups_adapt_at_mobile_breakpoint(self):
        # 13 since the advanced search gained an Origin group, a Custom fields
        # group and a Score group. The collapse wiring is attribute-driven, so a
        # new group inherits it -- this count is here to notice a group added by
        # hand somewhere the attribute is not.
        self.assertEqual(self.html.count("data-library-adaptive-group "), 13)
