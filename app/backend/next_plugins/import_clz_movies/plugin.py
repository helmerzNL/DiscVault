...
SOURCE = {
    ...
    "aliases": {
        ...
        "genre": ("Genre", "Genres"),
        "imdbId": ("IMDb ID", "IMDB ID", "IMDb", "IMDB", "IMDb Number", "IMDB Number", "IMDb URL", "IMDB URL", "IMDbURL", "imdb_id"),
        "tmdbId": ("TMDb ID", "TMDB ID", "TMDb", "TMDB", "TMDb URL", "TMDB URL", "TMDbURL", "tmdb_id"),
